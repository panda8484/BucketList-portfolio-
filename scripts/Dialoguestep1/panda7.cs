...
public class panda7 : MonoBehaviour
{
    ...
    public void EndDialogue()
    {
        ...
        SelectBox5.onClick.AddListener(DialogueSelect11);
    }

    private void DialogueSelect11()
    {
        SelectBox5.gameObject.SetActive(false);
        Dialogue4Manager11.gameObject.SetActive(true);
        Dialogue4Manager7.gameObject.SetActive(false);
    }
